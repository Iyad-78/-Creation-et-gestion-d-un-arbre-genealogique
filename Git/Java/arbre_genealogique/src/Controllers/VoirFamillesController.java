...
public class VoirFamillesController /*implements Initializable*/ {
    ...
    public void genererArbre(ActionEvent e){
        ...
        List<Personne> racines = arbre.getRoots();

        for(Personne p : racines){
            if(p.getNom().equals(nomFamilleLabel.getText())){
                racine=p;
            }
        }
